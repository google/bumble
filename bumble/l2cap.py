...
class ChannelManager:
    ...
    def __init__(
        ...
        self.pending_credit_based_connections = (
            {}
        )  # Credit-based connection request contexts, by identifier
    ...
    def on_l2cap_credit_based_connection_response(
        ...
        # Find the pending request by identifier
        if not (
            pending_connection := self.pending_credit_based_connections.pop(
    ...
    async def create_enhanced_credit_based_channels(
        ...
        self.pending_credit_based_connections[identifier] = (
            connection_result,
            channels,
        )
        self.send_control_frame(
