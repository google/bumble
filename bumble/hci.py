...
# Typing
# -----------------------------------------------------------------------------
_Fields = Sequence[Union[tuple[str, Any], '_Fields']]
...
class HCI_Command(HCI_Packet):
    ...
    op_code: int = -1
    fields: _Fields = ()
    return_parameters_fields: _Fields = ()

    @staticmethod
    def command(
        fields: Optional[_Fields] = None,
        return_parameters_fields: Optional[_Fields] = None,
    ):
        '''
        Decorator used to declare and register subclasses
        '''

        def inner(cls: type[_Command]) -> type[_Command]:
...
class HCI_Event(HCI_Packet):
    ...
    @staticmethod
    def event(fields: Optional[_Fields] = ()):
        '''
        Decorator used to declare and register subclasses
        '''

        def inner(cls: type[_Event]) -> type[_Event]:
            cls.name = cls.__name__.upper()
...
class HCI_Extended_Event(HCI_Event):
    ...
    @classmethod
    def event(cls, fields: Optional[_Fields] = None):
        '''
        Decorator used to declare and register subclasses
        '''

        def inner(cls: type[_ExtendedEvent]) -> type[_ExtendedEvent]:
            cls.name = cls.__name__.upper()
